...
const vector<ManufacturerSource>& manufacturerSources() { static const vector<ManufacturerSource> sources={
 ...
 {"vishay","Vishay","Vishay", "https://www.vishay.com/en/resistors/",{".csv",".xlsx"},{"Current-sense resistors"},DownloadMode::BrowserGuided,false,false,"vishay-current-sense-v1","Exact matching requires an explicit orderable-MPN column; series exports remain series-only."},
